...
SavedDesignsSelection = {
	...
	lower = vec2, -- vec2
	maxHorizontalEntries = 0, -- [read-only] unsigned
...
function SavedDesignsSelection:createAllianceEmblem(rect, allianceIndex)
	return AllianceEmblem
end
...
---@param rect Rect
---@return CaptainIcon
function SavedDesignsSelection:createCaptainIcon(rect)
	return CaptainIcon
end
...
function SavedDesignsSelection:createCaptainProfile(rect)
	return CaptainProfile
end
...
--- Inherited from UIContainer
---@return ContextMenu
function SavedDesignsSelection:createContextMenu()
	return ContextMenu
end
...
function SavedDesignsSelection:createCraftPortrait(rect, _function)
	return CraftPortrait
end
...
---@param rect Rect
---@return CrewBar
function SavedDesignsSelection:createCrewBar(rect)
	return CrewBar
end
...
---@return MapIcon
function SavedDesignsSelection:createMapIcon(texture, coordinates, color)
	return MapIcon
end
...
function SavedDesignsSelection:createTooltipDisplayer(rect)
	return TooltipDisplayer
end
...
--- Inherited from UIElement
---@return boolean
function SavedDesignsSelection:isMouseOverAndUnobscured()
	return true
end
...
---@param showBottom boolean
---@param width number
---@return any @nothing
function SavedDesignsSelection:setShowScrollArrows(showTop, showBottom, width)
	return nil
end
