...
function Window:createAllianceEmblem(rect, allianceIndex)
	return AllianceEmblem
end
...
---@param rect Rect
---@return CaptainIcon
function Window:createCaptainIcon(rect)
	return CaptainIcon
end
...
function Window:createCaptainProfile(rect)
	return CaptainProfile
end
...
--- Inherited from UIContainer
---@return ContextMenu
function Window:createContextMenu()
	return ContextMenu
end
...
function Window:createCraftPortrait(rect, _function)
	return CraftPortrait
end
...
---@param rect Rect
---@return CrewBar
function Window:createCrewBar(rect)
	return CrewBar
end
...
---@return MapIcon
function Window:createMapIcon(texture, coordinates, color)
	return MapIcon
end
...
function Window:createTooltipDisplayer(rect)
	return TooltipDisplayer
end
...
--- Inherited from UIElement
---@return boolean
function Window:isMouseOverAndUnobscured()
	return true
end
