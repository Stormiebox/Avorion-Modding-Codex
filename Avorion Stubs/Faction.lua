...
---@return Faction
---@param index any @The index of the faction
...
---@return Relation
function Faction:getRelation(otherFactionIndex)
	return Relation
end

---@param other number
---@return any
function Faction:getRelationStatus(other)
	return nil
end
...
---@param other number
---@return any
function Faction:getRelations(other)
	return nil
end
