...
---@return Captain
function ReadOnlyEntity:getCaptain()
	return Captain
end
...
---@return Box
function ReadOnlyEntity:getDockedGroupBoundingBox()
	return Box
end

--- Returns Bounding Box for entity, but enlarged to also fit around all docked objects. Use this if you need exact Bounding Box, e.g. for collision detection when entities are close to each other.
---@return Sphere
function ReadOnlyEntity:getDockedGroupBoundingSphere()
	return Sphere
end
...
---@return number
function ReadOnlyEntity:getMoneyLootAmount()
	return 0
end
...
---@return any
function ReadOnlyEntity:getNumMiningTurrets()
	return nil
end

---@return any
function ReadOnlyEntity:getNumSalvagingTurrets()
	return nil
end
...
---@return number
function ReadOnlyEntity:getResourceLootAmount()
	return 0
end
...
---@param other Entity
---@return boolean
function ReadOnlyEntity:isInDockingArea(other)
	return true
end
