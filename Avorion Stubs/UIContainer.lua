...
function UIContainer:createAllianceEmblem(rect, allianceIndex)
	return AllianceEmblem
end
...
---@param rect Rect
---@return CaptainIcon
function UIContainer:createCaptainIcon(rect)
	return CaptainIcon
end

---@param rect Rect
---@return CaptainProfile
function UIContainer:createCaptainProfile(rect)
	return CaptainProfile
end
...
---@return ContextMenu
function UIContainer:createContextMenu()
	return ContextMenu
end
...
function UIContainer:createCraftPortrait(rect, _function)
	return CraftPortrait
end

---@param rect Rect
---@return CrewBar
function UIContainer:createCrewBar(rect)
	return CrewBar
end
...
---@return MapIcon
function UIContainer:createMapIcon(texture, coordinates, color)
	return MapIcon
end
...
function UIContainer:createTooltipDisplayer(rect)
	return TooltipDisplayer
end
...
--- Inherited from UIElement
---@return boolean
function UIContainer:isMouseOverAndUnobscured()
	return true
end
