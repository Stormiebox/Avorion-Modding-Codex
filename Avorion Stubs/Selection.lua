...
Selection = {
	...
	showScrollBar = true, -- [write-only] bool
	size = vec2, -- vec2
	tooltip = nil, -- var
...
---@param amount number
---@return any @nothing
function Selection:addEmptyRows(amount)
	return nil
end
...
---@return any @nothing
function Selection:fillRow()
	return nil
end

---@return any @nothing
function Selection:fillWithEmptyRows()
	return nil
end
...
--- Inherited from UIElement
---@return boolean
function Selection:isMouseOverAndUnobscured()
	return true
end
...
---@param rects table_t
---@return any @nothing
function Selection:setCustomRects(rects)
	return nil
end

---@param _in number
---@return any @nothing
function Selection:setFieldSize(_in)
	return nil
end
...
---@param width number
---@return any @nothing
function Selection:setShowScrollArrows(showTop, showBottom, width)
	return nil
end
