...
---@param ray Ray @The ray used to intersect.
---@param t0 number @t1
---@param t1 number
---@return number,vec3 @nil if no intersection happened, or block index as first and intersection location as second return value
