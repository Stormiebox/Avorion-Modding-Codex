...
function InputWindow:createAllianceEmblem(rect, allianceIndex)
	return AllianceEmblem
end
...
---@param rect Rect
---@return CaptainIcon
function InputWindow:createCaptainIcon(rect)
	return CaptainIcon
end
...
function InputWindow:createCaptainProfile(rect)
	return CaptainProfile
end
...
--- Inherited from UIContainer
---@return ContextMenu
function InputWindow:createContextMenu()
	return ContextMenu
end
...
function InputWindow:createCraftPortrait(rect, _function)
	return CraftPortrait
end
...
---@param rect Rect
---@return CrewBar
function InputWindow:createCrewBar(rect)
	return CrewBar
end
...
---@return MapIcon
function InputWindow:createMapIcon(texture, coordinates, color)
	return MapIcon
end
...
function InputWindow:createTooltipDisplayer(rect)
	return TooltipDisplayer
end
...
--- Inherited from UIElement
---@return boolean
function InputWindow:isMouseOverAndUnobscured()
	return true
end
