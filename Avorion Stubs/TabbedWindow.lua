...
function TabbedWindow:createAllianceEmblem(rect, allianceIndex)
	return AllianceEmblem
end
...
---@param rect Rect
---@return CaptainIcon
function TabbedWindow:createCaptainIcon(rect)
	return CaptainIcon
end
...
function TabbedWindow:createCaptainProfile(rect)
	return CaptainProfile
end
...
--- Inherited from UIContainer
---@return ContextMenu
function TabbedWindow:createContextMenu()
	return ContextMenu
end
...
function TabbedWindow:createCraftPortrait(rect, _function)
	return CraftPortrait
end
...
---@param rect Rect
---@return CrewBar
function TabbedWindow:createCrewBar(rect)
	return CrewBar
end
...
---@return MapIcon
function TabbedWindow:createMapIcon(texture, coordinates, color)
	return MapIcon
end
...
function TabbedWindow:createTooltipDisplayer(rect)
	return TooltipDisplayer
end
...
--- Inherited from UIElement
---@return boolean
function TabbedWindow:isMouseOverAndUnobscured()
	return true
end
