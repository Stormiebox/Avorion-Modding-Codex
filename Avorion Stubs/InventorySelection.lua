...
function InventorySelection:createAllianceEmblem(rect, allianceIndex)
	return AllianceEmblem
end
...
---@param rect Rect
---@return CaptainIcon
function InventorySelection:createCaptainIcon(rect)
	return CaptainIcon
end
...
function InventorySelection:createCaptainProfile(rect)
	return CaptainProfile
end
...
--- Inherited from UIContainer
---@return ContextMenu
function InventorySelection:createContextMenu()
	return ContextMenu
end
...
function InventorySelection:createCraftPortrait(rect, _function)
	return CraftPortrait
end
...
---@param rect Rect
---@return CrewBar
function InventorySelection:createCrewBar(rect)
	return CrewBar
end
...
---@return MapIcon
function InventorySelection:createMapIcon(texture, coordinates, color)
	return MapIcon
end
...
function InventorySelection:createTooltipDisplayer(rect)
	return TooltipDisplayer
end
...
--- Inherited from UIElement
---@return boolean
function InventorySelection:isMouseOverAndUnobscured()
	return true
end
...
---@param width number
---@return any @nothing
function InventorySelection:setShowScrollArrows(showTop, showBottom, width)
	return nil
end
